// ==UserScript==
// @name         T3 Chat Usage Display
// @namespace    https://github.com/Appstun/Browser-Userscripts
// @version      1.3.0
// @description  Shows your remaining T3 Chat credits next to the chat input.
// @author       Appstun
// @match        https://t3.chat/*
...
// @downloadURL  https://github.com/Appstun/Browser-Userscripts/raw/main/scripts/t3chat-usage-display.user.js
// @updateURL    https://github.com/Appstun/Browser-Userscripts/raw/main/scripts/t3chat-usage-display.user.js
// ==/UserScript==
...
(() => {
  ...
  function getUsageParentElement() {
    ...
    const actionBar = childDivs.find(
      (child) => child.className.includes("flex-row-reverse") && child.className.includes("justify-between"),
    );
